...
def baseline_process(n_hours, K, masked_value, split_1, split_2):
    ...
    X_mask = past_future_mask   # this -mask was inputted into the flood manager. then should it also not be necessary to mask the future gate-pump data?
...
#     print("finished baseline process")
